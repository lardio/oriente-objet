...
/**
 * Classe de lancement de l'application de rescencement.
 * Récupération de données démographiques à partir d'un fichier.
 * Traitement des données via la classe Recensement.
 * Affichage des données via un menu interactif
 *
 * @author Sylvain
 *
 */
